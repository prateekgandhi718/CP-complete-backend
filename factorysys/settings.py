"""
Django settings for factorysys project.
...
SECRET_KEY = 'django-insecure-x3@x=#*q19i8545+=r7@jn87vqp+=arzv96$*bsbhz0ito4xip'
...
WSGI_APPLICATION = 'factorysys.wsgi.application'
